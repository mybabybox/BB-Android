...
public class GameGiftActivity extends TrackedFragmentActivity {
    ...
    private void redeemGameGift(final long id) {
        ...
        */
        ...
        if (gameGift.lpu > 0 && gameGift.pc >= gameGift.lpu) {
            String msg = getString(R.string.game_gifts_redeem_points_limit_per_user);
            msg = String.format(msg, gameGift.lpu);
